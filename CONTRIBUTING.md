...
| 作品 | 标题字体 | 正文字体 | 主色 | 色调 | 页面骨架 | 布局 | 交互 | 顶部大标题（点击回首页） |
|------|----------|----------|------|------|----------|------|------|--------------------------|
| 魔王勇者 | Lora | Work Sans | `#8B0000` | 冷学术 | header→hero→main→footer | 卡片网格 + 左侧 TOC | 筛选/折叠/TOC/返回顶部 | `.site-logo`（字号偏小，**未达「大标题」视觉重量，待强化**） |
| 食戟之灵 | Lora | Work Sans | `#C0392B` | 暖料理 | header→hero→main→footer | 卡片网格 + 右侧 TOC | 筛选/折叠/TOC/返回顶部 | `.site-logo`（字号偏小，**未达「大标题」视觉重量，待强化**） |
