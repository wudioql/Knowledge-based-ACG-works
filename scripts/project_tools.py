...
def show_help_panel() -> int:
    print("\n帮助 / 示例速查")
    print("=" * 18)
    print("可选领域：formal=形式科学, natural=自然科学, social=社会科学, humanities=人文学科和艺术, applied=应用科学与职业, other=其他")
    print("可选媒介：novel=小说, manga=漫画, anime=动画, game=游戏")
    print("")
    print("最小手册登记示例：")
    print('{')
